...
- [ ] Right-click on the dots: Show Tour, Keyboard Shortcuts, Settings…, Pin Panel Open (checkmark), Reset Panel Position and Size, Open at Login (checkmark), Quit Stoplight
