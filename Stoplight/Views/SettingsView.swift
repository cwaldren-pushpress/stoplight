    ...
    var body: some View {
        ...
        Form {
            ...
            Section("Legend") {
                ...
                LegendRow("An agent you launched is waiting on you: orange dot beside the menu bar lights, orange badge on the row, and a notification.") { Circle().fill(.orange).frame(width: 7, height: 7) }
